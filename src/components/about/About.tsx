...
const About = () => {
  ...
  return (
    <article className="flex flex-col min-h-screen sm:col-span-5 md:col-span-4 items-center">
       <h2 className="text-4xl text-center uppercase text-black mt-6">Acerca de</h2>
       <div className="w-4/5">
      ...
      <section className="grid grid-cols-1 xs:grid-cols-2 p-2 flex flex-col items-center mt-10 text-2xl gap-5 text-slate-600 p-2">
